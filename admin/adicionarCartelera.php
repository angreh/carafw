...
if (!empty($_GET) && isset($_GET['idfestival'])) {
    $tpl->addFile('CONTENIDO', 'paginas/admin/adicionarCartelera.html');
    $tpl->FESTIVAL_ID = $_GET['idfestival'];
} else {
    //bagaça para adcionar imagem
...
// Mantém o nome original do arquivo
            $nome_final = "festival_" . $_POST["idFestival"] . ".jpg";
        }
